...
?>
    ...
    <head>
      ...
      <title>Add Author - Rent Books</title>
      <!-- Custom CSS -->
        ...
        <div class="page-wrapper">
          ...
          <div class="page-breadcrumb">
            <div class="row">
              <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Add New Author</h4>
                <div class="d-flex align-items-center">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                      ...
                      <li class="breadcrumb-item text-muted active" aria-current="page">Author</li>
                    </ol>
                  </nav>
                </div>
              </div>
          ...
          <div class="container-fluid">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 px-0">
              <div class="card">
                <div class="card-body">
                  <form class="row g-3" action="simpan_data_pengarang.php" method="post">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="kode_pengarang" class="form-label">Author ID</label>
                        <input type="text" class="form-control" id="kode_pengarang" name="kode_pengarang" maxlength="8" placeholder="Unique Author ID" required>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="nama_pengarang" class="form-label">Author Name</label>
                        <input type="text" class="form-control" id="nama_pengarang" name="nama_pengarang" placeholder="ex. Mark Mason" required>
                      </div>
                    </div>
