...
?>
    ...
    <head>
      ...
      <title>My Rent - Rent Books</title>
          ...
          <div class="page-breadcrumb">
            <div class="row">
              <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">User Settings</h4>
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    <form class="row g-3" action="simpan_edit_peminjam.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <div class="custom-file">
                              ...
                              ?>
                                <input type="file" class="custom-file-input" id="foto_peminjam" name="foto_peminjam" accept="image/png, image/jpeg">
                                <input type="text" class="form-control" name="foto_peminjam_unchanged" value="<?php echo $data_peminjam[0]['foto']; ?>">
                                <label class="custom-file-label" for="foto_peminjam">No photo yet.</label>
                              <?php
                              } else {
                              ?>
                                <div class="col-md-12 px-0">
                                  <img src="<?php echo $data_peminjam[0]['foto']; ?>" alt="" width="100%" style="object-fit: cover;">
                                </div>
                                <div class="col-md-12 mt-3">
                                  <input type="file" class="custom-file-input" id="foto_peminjam" name="foto_peminjam" accept="image/png, image/jpeg">
                                  <input type="hidden" class="form-control" name="foto_peminjam_unchanged" value="<?php echo $data_peminjam[0]['foto']; ?>">
                                  <label class="custom-file-label" for="foto_peminjam">New photo?</label>
                                </div>
                              <?php
                              }
                              ?>
                        ...
                        <div class="row px-3">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="kode_peminjam" name="kode_peminjam" maxlength="8" value="<?php echo $data_peminjam[0]['kode_peminjam']; ?>" disabled>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="password" class="form-label">Password</label>
                              <input type="password" class="form-control" id="password" name="password" placeholder="New password?" value="<?php echo $data_peminjam[0]['password']; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
