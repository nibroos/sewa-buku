                  ...
                  <form class="row g-3" action="simpan_data_buku.php" method="post">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kode_buku" name="kode_buku" maxlength="8" placeholder="Unique Book ID" required>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="isbn" class="form-label">ISBN</label>
                        <input type="text" class="form-control" id="isbn" name="isbn" placeholder="Unique Registered Number" required>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="judul_buku" placeholder="ex. Insecurity is my middle name" required>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="kode_pengarang">Pengarang</label>
                        <select class="form-control select2" style="width: 100%" id="kode_pengarang" name="kode_pengarang">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" placeholder="Text Here..."></textarea>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="kode_jenis_buku">Genre</label>
                        <select class="form-control select2" style="width: 100%;" id="kode_jenis_buku" name="kode_jenis_buku">
