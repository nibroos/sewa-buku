          ...
          <div class="page-breadcrumb">
            <div class="row">
              <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">My Rent</h4>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="table-responsive">
                      <table id="my_rent" class="table table-striped table-bordered table-hover display no-wrap" style="width:100%">
                        <thead>
                          <tr>
                            <th>No</th>
                            <th>Judul Buku</th>
                        ...
                        <tbody>
                          <?php
                          $no = 1;
                          $y = $db->tampil_peminjaman_peminjam($username);
                          if ($y) {
                            foreach ($y as $x) {
                          ?>
                              <td><?php echo $no++; ?></td>
