...
?>
    ...
    <head>
      ...
      <title>Add Genre - Rent Books</title>
      <!-- Custom CSS -->
        ...
        <div class="page-wrapper">
          ...
          <div class="page-breadcrumb">
            <div class="row">
              <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Add New Genre</h4>
                <div class="d-flex align-items-center">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                      ...
                      <li class="breadcrumb-item text-muted active" aria-current="page">Genre</li>
                    </ol>
                  </nav>
                </div>
              </div>
          ...
          <div class="container-fluid">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 px-0">
              <div class="card">
                <div class="card-body">
                  <form class="row g-3" action="simpan_data_jenis_buku.php" method="post">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="kode_jenis_buku" class="form-label">Genre ID</label>
                        <input type="text" class="form-control" id="kode_jenis_buku" name="kode_jenis_buku" maxlength="8" placeholder="Unique Genre ID" required>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="nama_jenis_buku" class="form-label">Genre Name</label>
                        <input type="text" class="form-control" id="nama_jenis_buku" name="nama_jenis_buku" placeholder="ex. Psychological" required>
                      </div>
                    </div>
