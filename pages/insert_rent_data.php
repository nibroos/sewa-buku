        ...
        <div class="page-wrapper">
          ...
          <div class="page-breadcrumb">
            <div class="row">
              <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Add New Rental</h4>
                <div class="d-flex align-items-center">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                      <li class="breadcrumb-item"><a href="../admin_menu.php" class="text-muted">Home</a></li>
                      <li class="breadcrumb-item text-muted active" aria-current="page">Rent</li>
          ...
          <div class="container-fluid">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 px-0">
              <div class="card">
                <div class="card-body">
                  <form class="row g-3" action="simpan_peminjaman.php" method="post">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="kode_buku">Book Title</label>
                        <select class="form-control select2" style="width: 100%" id="kode_buku" name="kode_buku">
                          <option selected="selected">ex. Mindset: The New Psychology of Success</option>
                          <?php
                          $no = 1;
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="kode_peminjam">Renter</label>
                        <select class="form-control select2" style="width: 100%;" id="kode_peminjam" name="kode_peminjam">
                          <option selected="selected">ex. Kevin (A12341)</option>
                          <?php
                          $no = 1;
                          foreach ($db->ambil_data_peminjam() as $x) {
                            echo '<option value="' . $x['kode_peminjam'] . '">' .
                              $x['nama_peminjam'] . ' (' . $x['kode_peminjam'] . ')</option>';
                          }
                          ?>
                        </select>
                      </div>
