<?php 
    ...
    if( in_array($ekstensi, $daftar_list) ) {
        ...
        $koneksi->tambah_data_peminjam($_POST['kode_peminjam'],$_POST['nama_peminjam'],$_POST['jenis_kelamin'],
            $_POST['tanggal_lahir'],$_POST['alamat'],$_POST['pekerjaan'], $dir_foto_peminjam);
